...
<p>模型类也是更多多功能高级模型的基类，如<a href="guidelist?id=2">活动记录Active Record</a>。</p>
<p>&nbsp;</p>
<h2>属性</h2>
...
<p>上述例子假设你的模型基于活动记录（<a href="guidelist?id=2">Active Record</a>）。对于基本表单模型，很少使用场景，因为基本表单模型通常和某单个表单紧密结合。如上所说明， <code>scenarios()</code> 缺省实现返回每个具有验证规则的属性，这样就总是可以使用块赋值和验证。</p>
<p>&nbsp;</p>
<h2>验证</h2>
