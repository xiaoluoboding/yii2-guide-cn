...
<ol>
<li>配置数据提供器（<a href="0804.html">data provider</a>），它可以从数组、或SQL命令、或者一个Active Record查询等方式中获取数据。</li>
<li>把这个数据提供器传给一个界面小部件（widget）, 比如一个 <a href="0805.html#listview">list view</a> 或者 <a href="2003.html">grid view</a>。</li>
