<h1>资源管理（Assets）</h1>
<p>Yii 中的资源（asset） 是一个要引入页面的文件。可以是 CSS, JavaScript 或任何其他文件。框架提供了很多种途径来使用资源，从最简单的方式比如使用标签 &lt;script src="..."&gt; 添加文件（在<a href="0306.html"> 视图 </a>一章中描述），到高级应用比如发布不在web目录下的文件，解析Javascript依赖或者最小化CSS，接下来将分别进行描述。</p>
<p>&nbsp;</p>
<h2>声明资源包</h2>
