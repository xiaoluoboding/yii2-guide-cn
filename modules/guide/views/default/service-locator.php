...
<p>因为服务定位器，经常会在创建时附带<a href="0505.html">配置信息</a>， 因此我们提供了一个可写的属性，名为 [[yii\di\ServiceLocator::setComponents()|components]]，这样就可以配置该属性，或一次性注册多 个组件。下面的代码展示了如何用一个配置数组，配置一个应用并注册"db"，"cache" 和 "search" 三个组件：</p>
<pre class="brush: php;toolbar: false">
return [
    // ...
    'components' => [
