<h1>SQL查询生成器和查询</h1>
<p>Yii 提供了基本的数据访问层，描述在<a href="guidelist?id=21">数据库基础</a>部分。数据库访问层提供了数据库交互的底层方式，虽然一些情况很有用，但写原生的 SQL 语句容易出错、令人生厌。另一个可选的方案是使用查询生成器。查询生成器以面向对象的方式生成待执行的查询语句。</p>
<p>SQL查询生成器的典型用法如下：</p>
